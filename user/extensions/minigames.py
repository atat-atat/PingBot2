"""
TicTacToe based off of leovoel's tictactoe cog: https://gist.github.com/leovoel/5b2f9eaa8b346aeb88a3
"""
...
class Games():
    ...
    async def tictactoe(self, ctx, opponent : discord.Member=None):
        if opponent != ctx.message.author:
            ...
            await self.bot.say("You cannot start a game with yourself.")
